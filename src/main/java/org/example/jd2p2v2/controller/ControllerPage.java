...
public final class ControllerPage {
    ...
    public static final String PAGE_REDIRECT_LOGINATION =
            "page_redirect_logination";
    public static final String PAGE_REDIRECT_REGISTRATION =
            "page_redirect_registration";
    public static final String PAGE_REGISTRATION = "page_registration";
