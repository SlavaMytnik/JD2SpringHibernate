...
public final class ControllerMapping {
    ...
    public static final String SHOW_REGISTRATION_PAGE = "/showRegistrationPage";
    ...
    public static final String SHOW_REDIRECT_REGISTRATION_PAGE = "/showRedirectRegistrationPage";
    public static final String SHOW_REDIRECT_LOGINATION_PAGE = "/showRedirectLoginationPage";
